...
let gulp = require('gulp'),
  ...
  // mock = require('./' + app + '/route'),
  appScss = `${app}/asset/scss/**/*.scss`,
  appCss = `${app}/asset/css/**/*.css`,
  appJs = `${app}/asset/js/**/*.js`,
  appHtml = `${app}/**/*.html`,
  appEs = `${app}/asset/es/**/*.es6`,
  appTs = `${app}/asset/ts/**/*.ts`,
  appImg = `${app}/asset/images/**/*.*`,
  appCssDir = `${app}/asset/css`,
  appJsDir = `${app}/asset/js`,
  appEsDir = `${app}/asset/es`,
  appTsDir = `${app}/asset/ts`,
  appVendor = `${app}/asset/vendor/**/*.*`,
  expressEnter = `${app}/bin/WWW`,
  expressHtml = `${app}/views/**/*.html`,
  expressJs = `${app}/public/**/*.js`,
  expressCss = `${app}/public/**/*.css`,
  distHtmlDir = `${dist}/asset/html`,
  distCssDir = `${dist}/asset/css`,
  distJsDir = `${dist}/asset/js`,
  distCssRev = `${dist}/rev/css`;
distJsRev = `${dist}/rev/js`;
distImg = `${dist}/asset/images`,
  distVendor = `${dist}/asset/vendor`,
  distCss = `${dist}/asset/css/**/*.css`,
  distJs = `${dist}/asset/js/**/*.js`;
...
gulp.task('revdest', ['clean'], function() {
  gulp.start('revCss', 'revJs', 'cssmin', 'jsmin', 'copy', 'revHtml');
});
